...
@section('content')
    ...
    <div class="max-w-lg">
        <form method="POST" action="/customers/{{ $customer->id }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">{{ old('notes', $customer->notes) }}</textarea>
