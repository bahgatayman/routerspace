...
@section('content')
    <div class="max-w-2xl mx-auto">
        <a href="{{ route('workspaces.index') }}" class="text-sm text-blue-600 hover:text-blue-800 mb-4 inline-block">&larr; Back to Workspaces</a>

        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h1 class="text-xl font-bold text-gray-900 mb-6">Create Workspace</h1>
